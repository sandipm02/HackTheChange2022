    ...
    return (
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Stand out with your accomplishments</h2>
                <p class="text-gray-500 sm:text-xl dark:text-gray-400">Our process is unique as we remove hidden biases during the hiring process, ensuring that the best person is hired for the job while creating a more diverse and equal workplace.</p>
            </div>
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Expertise</h3>
                    <p class="text-gray-500 dark:text-gray-400">Impress with your vast knowledge of techonologies and outstanding nature of work.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Showcase your academic acheivement and dedication.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Experience</h3>
                    <p class="text-gray-500 dark:text-gray-400">Outline existing and previous experiences that make you the right fit.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Impact</h3>
                    <p class="text-gray-500 dark:text-gray-400">Provide your mission statement that shows your true influence.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Highlights</h3>
                    <p class="text-gray-500 dark:text-gray-400">Craft iterative and thoughtful statements of your cross-company capacity and collaboration.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Ability</h3>
                    <p class="text-gray-500 dark:text-gray-400">Demonstrate your history and aptitude to match with the right company.</p>
                </div>
            </div>
        </div>
        </section>
